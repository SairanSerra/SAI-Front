...
const RegisterProject:React.FC = () => {
    const{errors, handleSubmit, control, handleCreatePracticalTest, navigate
    } = useProject();
    return(
                ...
                <div className="relative container px-4 lg:py-20 mx-auto">
                    ...
                    <form action="#">
                        ...
                        <div className="max-w-2xl flex flex-wrap -mx-4 mb-3 ml-4">
                            <div className="w-full md:w-1/2">
                                <div className="flex items-center pl-6 mb-3 ">
                                    <div className="flex items-center pl-6 mb-3 bg-white rounded-full h-14 w-full">
                                        <span className="inline-block pr-3 border-r border-gray-50">
                                        ...
                                        <Controller
                                            ...
                                            render={({ field: { onChange, value } }) => (
                                                <DropdownCustom 
                                                    elements={ElementClassificationClient()} 
                                                    errors={errors.classClient !== undefined} 
                                                    onChange={onChange}
                                                    value={value} 
                                                />
                                            )} />
                        ...
                        <div className='flex w-2/5 justify-center'>
                            ...
                            <button color="primary" onClick={handleSubmit(handleCreatePracticalTest)} className="block w-full lg:w-auto py-4 px-12 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Salvar</button>
                        </div>
