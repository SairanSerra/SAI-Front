                        ...
                        <div className="flex flex-wrap -mx-10">
                            <div className="relative w-full lg:w-1/2 px-10 mb-10 lg:mb-20">
                                ...
                                <div className="px-16 pt-16 pb-24 bg-gray-600 rounded-lg">
                                    ...
                                    <h3 className="mt-12 mb-8 text-4xl font-bold text-white">Backups</h3>
                                    <p className="text-lg text-gray-200">Salva os status dos projetos em tempo de execução.</p>
                                </div>
                            </div>
                            <div className="relative w-full lg:w-1/2 px-10 mb-10 lg:mb-20">
                                ...
                                <div className="px-16 pt-16 pb-24 bg-gray-600 rounded-lg">
                                    <span className="flex mb-10 justify-center items-center w-20 h-20 bg-green-500 rounded-lg">
                                        <svg className="w-8 h-8" width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0)">
                                    ...
                                    <h3 className="mt-12 mb-8 text-4xl font-bold text-white">Documentos (em breve)</h3>
                                    <p className="text-lg text-gray-200">Validação de documentos.</p>
                                </div>
                            </div>
                            <div className="w-full lg:w-1/2 px-10 mb-10 lg:mb-20">
                                <div className="px-16 pt-16 pb-24 bg-gray-600 rounded-lg">
                                    ...
                                    <h3 className="mt-12 mb-8 text-4xl font-bold text-white">Navegação</h3>
                                    <p className="text-lg text-gray-200">Navegação entre os setores para observar, avaliar e validar cada processo</p>
                                </div>
                            </div>
                            <div className="w-full lg:w-1/2 px-10">
                                <div className="px-16 pt-16 pb-24 bg-gray-600 rounded-lg">
                                    <span className="flex mb-10 justify-center items-center w-20 h-20 bg-pink-500 rounded-lg">
                                        <svg className='w-10 text-white' fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 006 3.75v16.5a2.25 2.25 0 002.25 2.25h7.5A2.25 2.25 0 0018 20.25V3.75a2.25 2.25 0 00-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3"></path>
                                        </svg>
                                    </span>
                                    <h3 className="mt-12 mb-8 text-4xl font-bold text-white">Aplicativo (Em breve)</h3>
                                    <p className="text-lg text-gray-200">Todas funcionalidades web, também está disponivel em seu celular (ANDROID, IOS).</p>
                                </div>
                            </div>
                        </div>
                    </div>
