    ...
    return(
        ...
        <div className="w-full h-screen bg-gray-800">
            ...
            <div className="flex justify-end me-10 pt-14">
                <button className="block w-auto py-4 px-12 bg-blue-500 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Cadastrar Cotação</button>  
            </div>
