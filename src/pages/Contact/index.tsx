...
import OfficeTag from '../../assets/office-tag.svg';
...
const Contact: React.FC = () => {
    ...
    return(
        <>
            <section className="relative py-20 2xl:py-40 bg-gray-600 h-full">
                <div className="hidden lg:block absolute top-0 left-0 h-full bg-gray-800 w-1/2">
                    <img className="hidden lg:block absolute top-0 left-0 -ml-32 w-full h-full" src={Map} alt="Mapa" />
                    <img className="hidden lg:block absolute top-0 left-0 mt-40 ml-40" src={OfficeTag} alt="Local" />
                </div>
                <div className="container px-4 mx-auto">
                    <div className="w-full lg:w-1/2 ml-auto">
                        <div className="max-w-md lg:ml-20">
                            <div className="pb-16 mb-8 border-b border-gray-400">
                                <span className="text-lg text-blue-400 font-bold">Problemas?</span>
                                <h2 className="mt-10 mb-16 text-5xl font-bold font-heading text-white">Entre em contato</h2>
                                <div className="flex items-center mb-12">
                                    ...
                                    <p className="text-lg font-bold text-white">+55 11996076125</p>
                                </div>
                                <div className="flex items-center mb-12">
                                    <span className="flex items-center justify-center w-12 h-12 mr-8 bg-blue-500 rounded-lg">
                                        <svg className="w-4 h-4" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <p className="text-lg font-bold text-white">projetosai@gmail.com</p>
                                </div>
                                <div className="flex">
                                    ...
                                    <div>
                                        <p className="text-lg font-bold text-white">São Paulo, Brasil</p>
                                        <p className="text-lg font-bold text-white">R. José Weissohn, 153, Salto</p>
                                    </div>
                                </div>
                            </div>
                            <div className="max-w-xs">
                                <p className="text-gray-400">Contato de segunda a sexta das 8h ás 18h</p>
                            </div>
                        </div>
                    </div>
                </div>
